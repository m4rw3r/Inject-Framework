 ...
 */
/*
 * Modified by Martin Wernstahl to be self-contained when it comes to paths.
 * Previously it depended on the SYSPATH constant, now it is relative to the
 * path to this file.
 */
...
final class Utf8
{
	...
	/**
	 * A lis of methods which already has been called/lodaed.
	 * 
	 * @var array
	 */
	static $called = array();
	...
	public static function transliterate_to_ascii($str, $case = 0)
	{
		...
		{
			require UTF8_LIBPATH.__FUNCTION__.'.php';
